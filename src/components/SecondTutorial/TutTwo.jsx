    ...
    <div className="wrapperdivAlt">
      ...
      <div className="rightsideAlt">
        ...
        <p className="childtextAlt">
          Meet Emilio the sea lion, your guide to Scuba SEAsons, in this guide he shows you the basics of getting around Scuba SEAsons's map and explores the dive sites
        </p>
      </div>
    </div>
  );
